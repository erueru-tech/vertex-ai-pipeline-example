"""Vertex AI Pipelinesの操作に関するロジックをまとめたモジュール。"""
...
class PipelineClient:
    ...
    def __init__(
        ...
        enable_caching: bool | None = False,
    ...
    def create_schedule(
        ...
        Args:
            ...
            allow_queueing: max_concurrent_runs制限に達した時に新しくスケジュールされたジョブをキューに入れるか。
